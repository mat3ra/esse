...
class AtomicPositionsSchema(BaseModel):
    ...
    values: Optional[List[Value13]] = None
...
class KPointsSchema(BaseModel):
    ...
    values: Optional[Union[List[Value14], Values]] = None
...
class HubbardSchema(BaseModel):
    ...
    values: Optional[
        Union[List[Union[Values9, Values10]], List[Value15], List[Union[Values11, Values12, Values13]]]
    ] = None
