...
#   filename:  materials_category/primitive/base/crystal_site.json
#   version:   0.28.5
...
class LiteratureReferenceSchema3(BaseModel):
    type: Optional[Type11] = None
    doi: Optional[str] = None
    """
    Digital Object Identifier of the reference.
