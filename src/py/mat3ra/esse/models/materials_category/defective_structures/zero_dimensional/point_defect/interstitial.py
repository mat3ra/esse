...
class CrystalSchema55(BaseModel):
    ...
    derived_properties: Optional[List[DerivedPropertiesSchema59]] = Field(
        None, alias="derivedProperties", title="derived properties schema"
    )
    ...
    Whether to work in the finite molecular picture (usually with atomic orbital basis)
    """
    consistency_checks: Optional[List[MaterialConsistencyCheckSchema58]] = Field(None, alias="consistencyChecks")
    field_id: Optional[str] = Field(None, alias="_id")
    """
    entity identity
    """
