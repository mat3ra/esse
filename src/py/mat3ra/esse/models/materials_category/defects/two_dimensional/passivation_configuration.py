...
#   filename:  materials_category/defects/two_dimensional/passivation_configuration.json
#   version:   0.28.5
...
class PassivationConfigurationSchema(BaseModel):
    ...
    """
    The passivating element
    """
    bond_length: Optional[confloat(ge=0.0)] = 1
    """
    The bond length between surface atoms and passivants
    """
