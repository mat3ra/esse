...
#   filename:  materials_category/defects/two_dimensional/island/shapes/coordinate_conditions/triangular_prism.json
#   version:   0.28.5
...
class TriangularPrismCoordinateCondition(BaseModel):
