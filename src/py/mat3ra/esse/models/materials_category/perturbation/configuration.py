...
class PerturbationFunctionHolder(BaseModel):
    type: Literal["PerturbationFunctionHolder"]
    """
...
class SineWavePerturbationFunctionHolder(BaseModel):
...
class PerturbationConfigurationSchema(BaseModel):
    ...
    """
    The perturbation function to apply
    """
    use_cartesian_coordinates: Optional[bool] = True
    """
