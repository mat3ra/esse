...
class CrystalLatticeLinesUniqueRepeatedSchema(BaseModel):
    ...
    """
    termination_bottom: Optional[TerminationSchema26] = Field(None, title="Termination Schema")
    """
    Defines a specific termination of a slab
    """
...
class SymmetrySchema63(BaseModel):
    ...
    space group symbol in Hermann–Mauguin notation
    """
    tolerance: Optional[ScalarSchema64] = Field(None, title="scalar schema")
    """
    tolerance used for symmetry calculation
    """
    name: Literal["2#-datamodel-code-generator-#-object-#-special-#"]
...
class NanoribbonConfigurationSchema(BaseModel):
    stack_components: List[Union[NanoTapeConfigurationSchema, VacuumConfigurationSchema26]] = Field(
        ..., max_length=2, min_length=2
    )
