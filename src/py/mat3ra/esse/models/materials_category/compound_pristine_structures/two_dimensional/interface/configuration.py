...
class SlabStrainedSupercellConfigurationSchema3(BaseModel):
    ...
    stack_components: List[Union[AtomicLayersUniqueRepeatedSchema13, VacuumConfigurationSchema13]] = Field(
        ..., max_length=2, min_length=2
    )
    direction: Optional[AxisEnum] = Field("z", title="Axis Enum")
    """
...
class SlabStrainedSupercellWithGapConfigurationSchema3(BaseModel):
    ...
    stack_components: List[Union[AtomicLayersUniqueRepeatedSchema14, VacuumConfigurationSchema14]] = Field(
        ..., max_length=2, min_length=2
    )
    direction: Optional[AxisEnum] = Field("z", title="Axis Enum")
    """
