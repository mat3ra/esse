...
#   filename:  materials_category/compound_pristine_structures/two_dimensional/interfaces/with_no_vacuum.json
#   version:   0.28.5
...
class SlabConfigurationSchema2(BaseModel):
    ...
    Supercell matrix for xy plane transformations
    """
    stack_components: List[Union[AtomicLayersUniqueRepeatedSchema4, VacuumConfigurationSchema5]] = Field(
        ..., max_length=2, min_length=2
    )
    direction: Optional[AxisEnum] = Field("z", title="Axis Enum")
    """
...
class InterfaceWithNoVacuumSchema(BaseModel):
    stack_components: List[Union[SlabConfigurationSchema, SlabConfigurationSchema2]] = Field(
        ..., max_length=2, min_length=2
    )
    """
