...
#   filename:  materials_category/compound_pristine_structures/two_dimensional/interfaces/configuration.json
#   version:   0.28.5
...
class CrystalSchema4(BaseModel):
    formula: Optional[str] = None
    """
    reduced chemical formula
    """
...
class VacuumConfigurationSchema(BaseModel):
    ...
    """
    crystal: CrystalSchema4 = Field(..., title="Crystal Schema")
    """
    A crystal structure, referencing the base material schema
    """
...
class InterfaceConfigurationSchema(BaseModel):
    stack_components: List[Union[SlabConfigurationSchema, SlabConfigurationSchema1, VacuumConfigurationSchema2]] = (
