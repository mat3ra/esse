...
#   filename:  materials_category/compound_pristine_structures/two_dimensional/interfaces/with_vacuum.json
#   version:   0.28.5
...
class SlabConfigurationSchema4(BaseModel):
    ...
    Supercell matrix for xy plane transformations
    """
    stack_components: List[Union[AtomicLayersUniqueRepeatedSchema6, VacuumConfigurationSchema7]] = Field(
        ..., max_length=2, min_length=2
    )
    direction: Optional[AxisEnum] = Field("z", title="Axis Enum")
    """
...
class InterfaceWithVacuumSchema(BaseModel):
    stack_components: List[Union[SlabConfigurationSchema, SlabConfigurationSchema4, VacuumConfigurationSchema8]] = (
