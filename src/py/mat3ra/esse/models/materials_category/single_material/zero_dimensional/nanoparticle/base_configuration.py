...
#   filename:  materials_category/single_material/zero_dimensional/nanoparticle/base_configuration.json
#   version:   0.25.5
...
class BaseNanoparticleConfigurationSchema(BaseModel):
