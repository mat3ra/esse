...
#   filename:  materials_category/single_material/zero_dimensional/nanoparticle/slab_based/configuration.json
#   version:   0.25.5
...
class SlabBasedNanoparticleConfigurationSchema(BaseModel):
    supercell_size: Optional[conint(ge=1)] = 1
    """
    Size of the supercell in the xy-plane
    """
    orientation_z: Optional[Union[List[float], List[bool]]] = Field([0, 0, 1], title="Miller Indices Schema")
    """
    Miller indices for crystallographic plane designation
    """
    material: MaterialSchema = Field(..., title="material schema")
    vacuum_padding: Optional[confloat(ge=0.0)] = 10
    """
    Vacuum padding around the nanoparticle in Angstroms
    """
