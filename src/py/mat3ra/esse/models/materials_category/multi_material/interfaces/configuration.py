...
class AtomicElementSchema4(BaseModel):
    value: Union[Value10, Value11]
    """
    All elements, including extra elements
    """
    id: int
...
class BasisSchema2(BaseModel):
    elements: List[AtomicElementSchema4] = Field(..., title="atomic elements schema")
    """
    atomic elements schema
    """
    coordinates: List[AtomicCoordinateSchema] = Field(..., title="atomic coordinates schema")
...
class LatticeVectorsSchema1(BaseModel):
    a: List[float] = Field(..., max_length=3, min_length=3, title="vector 3d schema")
    b: List[float] = Field(..., max_length=3, min_length=3, title="vector 3d schema")
    c: List[float] = Field(..., max_length=3, min_length=3, title="vector 3d schema")
    alat: Optional[float] = 1
...
class LatticeUnitsSchema1(BaseModel):
    length: Optional[LatticeUnitsLengthEnum] = Field("angstrom", title="lattice units length enum")
    angle: Optional[LatticeUnitsAngleEnum] = Field("degree", title="lattice units angle enum")


class LatticeSchema1(BaseModel):
    a: float
    """
    length of the first lattice vector
    """
    ...
    angle between first and third lattice vector
    """
    vectors: Optional[LatticeVectorsSchema1] = Field(None, title="lattice vectors schema")
    type: Optional[LatticeTypeEnum] = Field("TRI", title="lattice type enum")
    units: Optional[LatticeUnitsSchema1] = Field(
        default_factory=lambda: LatticeUnitsSchema1.model_validate({"length": "angstrom", "angle": "degree"}),
        title="Lattice units schema",
    )
...
class DensitySchema1(BaseModel):
    name: Literal["1#-datamodel-code-generator-#-object-#-special-#"]
...
class SymmetrySchema1(BaseModel):
    pointGroupSymbol: Optional[str] = None
    """
    point group symbol in Schoenflies notation
    """
    ...
    space group symbol in Hermann–Mauguin notation
    """
    tolerance: Optional[ScalarSchema2] = Field(None, title="scalar schema")
    """
    tolerance used for symmetry calculation
    """
    name: Literal["2#-datamodel-code-generator-#-object-#-special-#"]
...
class ElementalRatio1(BaseModel):
    name: Literal["3#-datamodel-code-generator-#-object-#-special-#"]
    value: confloat(ge=0.0, le=1.0)
    element: Optional[str] = None
    """
...
class InChIRepresentationSchema1(BaseModel):
    name: Literal["5#-datamodel-code-generator-#-object-#-special-#"]
    value: str
...
class InChIKeyRepresentationSchema1(BaseModel):
    name: Literal["6#-datamodel-code-generator-#-object-#-special-#"]
    value: str
...
class DerivedPropertiesSchema1(
    RootModel[
        Union[
            ...
            ElementalRatio1,
            PNorm1,
            InChIRepresentationSchema1,
            InChIKeyRepresentationSchema1,
        ]
    ]
):
    root: Union[
...
class MaterialConsistencyCheckSchema1(BaseModel):
    name: Name22
    """
    Name of the consistency check that is performed, which is listed in an enum.
    """
...
class MaterialSchema1(BaseModel):
    formula: Optional[str] = None
    """
    reduced chemical formula
    """
    ...
    chemical formula based on the number of atoms of each element in the supercell
    """
    basis: BasisSchema2 = Field(..., title="basis schema")
    lattice: LatticeSchema1 = Field(..., title="lattice schema")
    derivedProperties: Optional[List[DerivedPropertiesSchema1]] = Field(None, title="derived properties schema")
    external: Optional[DatabaseSourceSchema] = Field(None, title="database source schema")
    """
    information about a database source
    """
    ...
    Whether to work in the finite molecular picture (usually with atomic orbital basis)
    """
    consistencyChecks: Optional[List[MaterialConsistencyCheckSchema1]] = None
    field_id: Optional[str] = Field(None, alias="_id")
    """
    entity identity
    """
...
class SlabConfigurationSchema1(BaseModel):
    bulk: Optional[MaterialSchema1] = Field(None, title="material schema")
    miller_indices: Optional[List[int]] = Field([0, 0, 1], max_length=3, min_length=3, title="Miller Indices Schema")
    """
    Miller indices for crystallographic plane designation
    """
...
class SlabWithTerminationConfigurationSchema1(BaseModel):
    slab_configuration: SlabConfigurationSchema1 = Field(..., title="Slab Configuration Schema")
    """
    Configuration for creating a slab from a bulk material
    """
    termination: TerminationSchema = Field(..., title="Termination Schema")
...
class InterfaceConfigurationSchema(BaseModel):
    slab_with_termination_configuration_1: Optional[SlabWithTerminationConfigurationSchema] = Field(
        None, title="Slab with Termination Configuration Schema"
    )
    """
    Configuration for a slab with termination
    """
    slab_with_termination_configuration_2: Optional[SlabWithTerminationConfigurationSchema1] = Field(
        None, title="Slab with Termination Configuration Schema"
    )
    """
    Configuration for a slab with termination
    ...
    """
    Thickness of the vacuum region above the first slab
    """
