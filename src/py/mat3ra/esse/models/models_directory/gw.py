...
class GWCategorySchema(BaseModel):
    ...
    """
    subtype: Optional[Union[SlugifiedEntry, SlugifiedEntryOrSlug147]] = Field(None, title="slugified entry or slug")
    """
    contains either object with slugified entry or slug only as a string
    """
...
class LDAFunctionalMixin1(BaseModel):
    ...
    functional: Optional[Functional24] = None
