...
class AxisSchema(BaseModel):
    ...
    """
    units: Optional[Units235] = "crystal"
    """
    units for an axis
    """
...
class AxisSchema13(BaseModel):
    ...
    label of an axis object
    """
    units: Optional[Units237] = "crystal"
    """
    units for an axis
    """
...
class JupyterNotebookEndpointPropertySchema(BaseModel):
    name: Literal["47#-datamodel-code-generator-#-object-#-special-#"]
    host: str
    port: float
    token: str
