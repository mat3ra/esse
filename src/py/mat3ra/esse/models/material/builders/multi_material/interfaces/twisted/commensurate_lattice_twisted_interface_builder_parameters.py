...
#   filename:  material/builders/multi_material/interfaces/twisted/commensurate_lattice_twisted_interface_builder_parameters.json
#   version:   0.28.5
...
class CommensurateLatticeTwistedInterfaceBuilderParametersSchema(BaseModel):
