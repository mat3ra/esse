...
#   filename:  material/reusable/stack/stack_of_slabs.json
#   version:   0.28.5
...
class StackOfSlabsConfigurationSchema(BaseModel):
    stack_slab_configurations: List[SlabInStackConfigurationSchema] = Field(..., min_length=2)
    """
