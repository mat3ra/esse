...
#   filename:  material/reusable/two_dimensional/slab_unit_cell_alt.json
#   version:   0.28.5
...
class AlternativeSlabUnitCellSchema(BaseModel):
    stack_components: List[Union[CrystalSchema8, VacuumSchema, CrystalSchema11, VacuumSchema4]] = Field(
        ..., min_length=2
    )
    """
