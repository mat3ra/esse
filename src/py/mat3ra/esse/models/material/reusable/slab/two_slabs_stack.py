...
class MaterialSchema21(BaseModel):
    formula: Optional[str] = None
    """
    reduced chemical formula
    """
...
class SlabConfigurationSchema8(BaseModel):
    bulk: Optional[MaterialSchema21] = Field(None, title="material schema")
    miller_indices: Optional[List[int]] = Field([0, 0, 1], max_length=3, min_length=3, title="Miller Indices Schema")
    """
    Miller indices for crystallographic plane designation
    """
...
class SlabWithTerminationConfigurationSchema4(BaseModel):
    slab_configuration: SlabConfigurationSchema8 = Field(..., title="Slab Configuration Schema")
    """
    Configuration for creating a slab from a bulk material
    """
    termination: TerminationSchema = Field(..., title="Termination Schema")
...
class TwoSlabsStackConfigurationSchema(BaseModel):
    ...
    """
    slab_with_termination_configuration_2: Optional[SlabWithTerminationConfigurationSchema4] = Field(
        None, title="Slab with Termination Configuration Schema"
    )
    """
    Configuration for a slab with termination
