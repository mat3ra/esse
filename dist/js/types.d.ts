 ...
 */
export interface SlabGrainBoundaryConfigurationSchema {
    /**
...
/** Schema dist/js/schema/materials_category/defects/zero_dimensional/adatom/base_configuration.json */
/**
 * Base configuration for adatom defects on a surface
 */
export interface AdatomConfigurationWithoutCrystalSchema {
    crystal?: {
        /**
         * reduced chemical formula
         */
 ...
 */
export interface PointDefectPairConfigurationSchema {
    defect_type?: "pair";
    /**
...
/** Schema dist/js/schema/materials_category/defects/zero_dimensional/point/base_configuration.json */
/**
 * Base configuration for point defects in a crystal
 */
export interface BasePointDefectConfigurationSchema {
    defect_type: "vacancy" | "substitution" | "interstitial" | "adatom";
    /**
     * @minItems 3
     * @maxItems 3
