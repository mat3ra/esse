...
class BaseContextItemSchema197(BaseModel):
...
class BaseContextItemSchema198(BaseModel):
    name: Name
...
class BaseContextItemSchema199(BaseModel):
    name: Name786
...
class BaseContextItemSchema200(BaseModel):
...
class BaseContextItemSchema201(BaseModel):
...
class BaseContextItemSchema202(BaseModel):
...
class BaseContextItemSchema203(BaseModel):
...
class BaseContextItemSchema204(BaseModel):
    name: Literal["neb"]
...
class BaseContextItemSchema205(BaseModel):
...
class BaseContextItemSchema206(BaseModel):
...
class BaseContextItemSchema207(BaseModel):
...
class BaseContextItemSchema208(BaseModel):
...
class BaseContextItemSchema209(BaseModel):
...
class BaseContextItemSchema210(BaseModel):
...
class ExecutionUnitSchemaBase(BaseModel):
    ...
    context: List[
        Union[
            ...
            BaseContextItemSchema197,
            BaseContextItemSchema198,
            BaseContextItemSchema199,
            BaseContextItemSchema200,
            BaseContextItemSchema201,
            BaseContextItemSchema202,
            BaseContextItemSchema203,
            BaseContextItemSchema204,
            BaseContextItemSchema205,
            BaseContextItemSchema206,
            BaseContextItemSchema207,
            BaseContextItemSchema208,
            BaseContextItemSchema209,
            BaseContextItemSchema210,
        ]
    ]
