...
class BaseContextItemSchema122(BaseModel):
...
class BaseContextItemSchema123(BaseModel):
    name: Name
...
class BaseContextItemSchema124(BaseModel):
    name: Name573
...
class BaseContextItemSchema125(BaseModel):
...
class BaseContextItemSchema126(BaseModel):
...
class BaseContextItemSchema127(BaseModel):
...
class BaseContextItemSchema128(BaseModel):
...
class BaseContextItemSchema129(BaseModel):
    name: Literal["neb"]
...
class BaseContextItemSchema130(BaseModel):
...
class BaseContextItemSchema131(BaseModel):
...
class BaseContextItemSchema132(BaseModel):
...
class BaseContextItemSchema133(BaseModel):
...
class BaseContextItemSchema134(BaseModel):
...
class BaseContextItemSchema135(BaseModel):
...
class ESSE(
    RootModel[
        Union[
            ...
            BaseContextItemSchema122,
            BaseContextItemSchema123,
            BaseContextItemSchema124,
            BaseContextItemSchema125,
            BaseContextItemSchema126,
            BaseContextItemSchema127,
            BaseContextItemSchema128,
            BaseContextItemSchema129,
            BaseContextItemSchema130,
            BaseContextItemSchema131,
            BaseContextItemSchema132,
            BaseContextItemSchema133,
            BaseContextItemSchema134,
            BaseContextItemSchema135,
        ]
    ]
):
    root: Union[
        ...
        BaseContextItemSchema134,
        BaseContextItemSchema135,
    ] = Field(..., title="context item schema")
