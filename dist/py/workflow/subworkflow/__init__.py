...
class BaseContextItemSchema182(BaseModel):
...
class BaseContextItemSchema183(BaseModel):
    name: Name
...
class BaseContextItemSchema184(BaseModel):
    name: Name757
...
class BaseContextItemSchema185(BaseModel):
...
class BaseContextItemSchema186(BaseModel):
...
class BaseContextItemSchema187(BaseModel):
...
class BaseContextItemSchema188(BaseModel):
...
class BaseContextItemSchema189(BaseModel):
    name: Literal["neb"]
...
class BaseContextItemSchema190(BaseModel):
...
class BaseContextItemSchema191(BaseModel):
...
class BaseContextItemSchema192(BaseModel):
...
class BaseContextItemSchema193(BaseModel):
...
class BaseContextItemSchema194(BaseModel):
...
class BaseContextItemSchema195(BaseModel):
...
class ExecutionUnitSchemaBase(BaseModel):
    ...
    context: List[
        Union[
            ...
            BaseContextItemSchema182,
            BaseContextItemSchema183,
            BaseContextItemSchema184,
            BaseContextItemSchema185,
            BaseContextItemSchema186,
            BaseContextItemSchema187,
            BaseContextItemSchema188,
            BaseContextItemSchema189,
            BaseContextItemSchema190,
            BaseContextItemSchema191,
            BaseContextItemSchema192,
            BaseContextItemSchema193,
            BaseContextItemSchema194,
            BaseContextItemSchema195,
        ]
    ]
