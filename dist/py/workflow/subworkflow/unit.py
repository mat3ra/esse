...
class BaseContextItemSchema212(BaseModel):
...
class BaseContextItemSchema213(BaseModel):
    name: Name
...
class BaseContextItemSchema214(BaseModel):
    name: Name788
...
class BaseContextItemSchema215(BaseModel):
...
class BaseContextItemSchema216(BaseModel):
...
class BaseContextItemSchema217(BaseModel):
...
class BaseContextItemSchema218(BaseModel):
...
class BaseContextItemSchema219(BaseModel):
    name: Literal["neb"]
...
class BaseContextItemSchema220(BaseModel):
...
class BaseContextItemSchema221(BaseModel):
...
class BaseContextItemSchema222(BaseModel):
...
class BaseContextItemSchema223(BaseModel):
...
class BaseContextItemSchema224(BaseModel):
...
class BaseContextItemSchema225(BaseModel):
...
class ExecutionUnitSchemaBase(BaseModel):
    ...
    context: List[
        Union[
            ...
            BaseContextItemSchema212,
            BaseContextItemSchema213,
            BaseContextItemSchema214,
            BaseContextItemSchema215,
            BaseContextItemSchema216,
            BaseContextItemSchema217,
            BaseContextItemSchema218,
            BaseContextItemSchema219,
            BaseContextItemSchema220,
            BaseContextItemSchema221,
            BaseContextItemSchema222,
            BaseContextItemSchema223,
            BaseContextItemSchema224,
            BaseContextItemSchema225,
        ]
    ]
