...
class BaseContextItemSchema62(BaseModel):
...
class BaseContextItemSchema63(BaseModel):
    name: Name
...
class BaseContextItemSchema64(BaseModel):
    name: Name478
...
class BaseContextItemSchema65(BaseModel):
...
class BaseContextItemSchema66(BaseModel):
...
class BaseContextItemSchema67(BaseModel):
...
class BaseContextItemSchema68(BaseModel):
...
class BaseContextItemSchema69(BaseModel):
    name: Literal["neb"]
...
class BaseContextItemSchema70(BaseModel):
...
class BaseContextItemSchema71(BaseModel):
...
class BaseContextItemSchema72(BaseModel):
...
class BaseContextItemSchema73(BaseModel):
...
class BaseContextItemSchema74(BaseModel):
...
class BaseContextItemSchema75(BaseModel):
...
class ExecutionUnitSchemaForScriptingBasedApplications(BaseModel):
    ...
    context: List[
        Union[
            ...
            BaseContextItemSchema62,
            BaseContextItemSchema63,
            BaseContextItemSchema64,
            BaseContextItemSchema65,
            BaseContextItemSchema66,
            BaseContextItemSchema67,
            BaseContextItemSchema68,
            BaseContextItemSchema69,
            BaseContextItemSchema70,
            BaseContextItemSchema71,
            BaseContextItemSchema72,
            BaseContextItemSchema73,
            BaseContextItemSchema74,
            BaseContextItemSchema75,
        ]
    ]
